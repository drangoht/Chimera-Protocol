...
- **Biome affinities — *where* you assimilate matters.** A graft captures the biome it was taken in and keeps its affinity for the whole run: Sanctuary +12% damage, Aether Wastes +20% range, Furnace adds **burn** on hit, Frost adds **slow** on hit, Neon Sector −18% cooldown. The same Symbiotic Swarm burns in the Furnace and freezes in the Frost.
- **Challenges & rewards** — **13 challenges** across combat, survival, assimilation and mastery (First Blood, The Long Watch, Full Chimera, World Eater, Exterminator…), checked at the end of each run. They pay in Echoes, unlock **starting perks** (begin a run with a free graft, a second weapon, or +1 graft slot) and cosmetic **titles** (The Chimera, Apex Predator, Exterminator) displayed under the main menu logo.
...
### Setting
*The Convergence changed everything.* When magic and machine intertwined, they birthed the **Living Rust**: a half-organic, half-mechanical corruption that devours the world and reanimates its husks. The **Sanctuaries**, last bastions, still hold **Aether Cores** — condensed pure energy, the only hope of pushing the Rust back. You are a **Walker**: a man/machine/magic fused fighter sent to extract from a fallen Sanctuary. Survive the Rust tides, harvest the Cores, and bring down what guards them before you extract. *"One day, it will be you."*
...
- Pricing: free / "No payments" (adjust if you want donations) — confirm yourself
- **AI generation disclosure** (itch.io asks for it): tick *"Yes — contains AI-generated assets"*, the
  soundtrack is generated with Suno (prompts in `docs/AUDIO_AI_PROMPTS.md`). Code, sprites, VFX and
  SFX are not AI-generated (SFX are CC0 by Kenney). Reminder: the Suno free plan is
  **non-commercial** — keep the game free or regenerate under a paid plan
  (`assets/audio/CREDITS.md`).

## HTML version (ready to paste into the itch.io editor)

> Same copy as above, as HTML. itch.io's editor accepts pasted HTML in source mode.
...
<h3>Highlights</h3>
<ul>
<li><strong>A third progression axis: Assimilation.</strong> <em>"Don't kill the monsters. Become them."</em> Every enemy archetype (Swarm, Drone, Sentinel, Colossus) has its own gauge, filled by your kills; a full gauge offers a graft from a pool of <strong>5</strong> (Symbiotic Swarm, Erratic Servos, Aiming Eye, Grafted Carapace, Stalker's Wave). <strong>3 slots</strong> by default, up to <strong>5</strong> through the Hub. Grafts visibly reshape your body &mdash; attached plating, thrusters, a floating eye &mdash; and the right pair <strong>fuses</strong> into an epic form that frees a slot: <strong>Armored Charge</strong> (your dash becomes an impact charge), <strong>Turret Hive</strong> (your swarms become 4 auto-turrets covering 360&deg;) or <strong>Nova Strike</strong> (your dash becomes an offensive blink that detonates on arrival). Armored Charge and Nova Strike share a component, so they're mutually exclusive &mdash; pick your build.</li>
<li><strong>Biome affinities &mdash; <em>where</em> you assimilate matters.</strong> A graft captures the biome it was taken in and keeps its affinity for the whole run: Sanctuary +12% damage, Aether Wastes +20% range, Furnace adds <strong>burn</strong> on hit, Frost adds <strong>slow</strong> on hit, Neon Sector &minus;18% cooldown. The same Symbiotic Swarm burns in the Furnace and freezes in the Frost.</li>
<li><strong>Challenges &amp; rewards</strong> &mdash; <strong>13 challenges</strong> across combat, survival, assimilation and mastery (First Blood, The Long Watch, Full Chimera, World Eater, Exterminator&hellip;), checked at the end of each run. They pay in Echoes, unlock <strong>starting perks</strong> (begin a run with a free graft, a second weapon, or +1 graft slot) and cosmetic <strong>titles</strong> (The Chimera, Apex Predator, Exterminator) displayed under the main menu logo.</li>

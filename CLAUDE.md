...
**Phase actuelle : libre.** Dernières livraisons : visée souris/stick + réticule pour la Lance
Vectorielle, fusions Rayon Vecteur & Voile de Givre (brume de froid + ennemis gelés), 2026-07-05.
Version publiée itch : **1.8.1**. Détail dans `docs/PROJECT_STATE.md`.

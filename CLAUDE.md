...
- Phase actuelle : **Expansion Phase 3 (lot 1/3) — 2 nouvelles armes : Lame Boomerang + Essaim Traqueur — 2026-06-30**. (cf. `docs/EXPANSION_PLAN.md` ; reste : cryo_lance, pyre_stream, singularity → nécessitent des effets de statut slow/DoT/pull sur `EnemyBase`)

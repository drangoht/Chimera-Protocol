...
public partial class AudioSystem : Node
{
    ...
    private static float MixGainDb(string sfxId) => sfxId switch
    {
        ...
        // Mort des ennemis erratiques (−17,1 dB depuis que le fichier est raccourci) → ~−23 dB,
        // sous l'AUTRE son de mort de fourrage (`sfx_enemy_swarm_die`, −21,0). Il est joué par toute
        // la faune erratique — six espèces qui arrivent d'un bloc à la 3ᵉ minute avec 11 à 17 PV,
        // donc mortes au premier coup. Le fichier tenait 1,36 s de niveau CONSTANT là où celui de la
        // nuée en dure 0,16 : le plus long et le plus fort de la banque servait le plus grand nombre.
        // Ici le pool de 8 canaux borne l'empilement en volant le plus ancien ; le portage Unity, qui
        // en a 24, a dû ajouter un plafond PAR SON.
        "sfx_enemy_drone_die"           => -6.0f,

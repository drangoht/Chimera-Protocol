...
public partial class LevelUpSystem : Node
{
    ...
    private static readonly string[] AllWeaponIds  = { "impulse_cannon", "plasma_blade", "drone_swarm", "overload_field", "tesla_coil", "scatter_volley", "glaive", "seeker_swarm", "cryo_lance", "pyre_stream" };

...
public partial class LevelUpSystem : Node
{
    ...
    private static readonly string[] AllFusionIds  = { "fusion_blade", "rail_overcharged", "orbital_swarm", "overload_aegis", "ionic_storm", "solar_column", "hornet_swarm", "vector_beam" };

...
public static class ChallengeTable
{
    ...
    /// </summary>
    /// <remarks>
    /// Écrit en <c>readonly struct</c> et non en <c>record struct</c> : Unity 6.5 compile en
    /// <b>C# 9</b>, où les <i>record structs</i> (C# 10) et les accesseurs <c>init</c>
    /// (<c>IsExternalInit</c>, absent de netstandard2.1) ne sont pas disponibles.
    /// Conversion sans effet de bord : aucun appelant n'utilisait les sémantiques de record
    /// (égalité par valeur, <c>with</c>, déconstruction) — seuls deux sites la construisent.
    /// Cf. docs/UNITY_MIGRATION_PLAN.md §5.
    /// </remarks>
    public readonly struct ChallengeContext
    {
        public readonly int RunTimeSeconds;
        public readonly int RunKills;
        public readonly int RunCores;
        public readonly bool LevelCompleted;
        public readonly string BiomeId;
        public readonly int DifficultyRank;        // Facile=0, Normal=1, Difficile=2
        public readonly int RunGraftsEquipped;
        public readonly bool RunFusionForged;
        public readonly long LifetimeKills;
        public readonly int LifetimeRuns;
        public readonly int BiomesCompletedCount;
            ...
            int BiomesCompletedCount)
        {
            ...
            this.RunKills             = RunKills;
            this.RunCores             = RunCores;
            this.LevelCompleted       = LevelCompleted;
            this.BiomeId              = BiomeId;
            this.DifficultyRank       = DifficultyRank;
            this.RunGraftsEquipped    = RunGraftsEquipped;
            this.RunFusionForged      = RunFusionForged;
            this.LifetimeKills        = LifetimeKills;
            this.LifetimeRuns         = LifetimeRuns;
            this.BiomesCompletedCount = BiomesCompletedCount;
        }
    }
